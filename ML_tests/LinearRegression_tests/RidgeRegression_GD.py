...
# If run from local:
# sys.path.append('../../ML/algorithms/linearregression')
from ridge_regression_gradient_descent import RidgeRegression


class TestRidgeRegression_GradientDescent(unittest.TestCase):
...
if __name__ == "__main__":
    print("Running Ridge Regression Gradient Descent tests:")
    unittest.main()
